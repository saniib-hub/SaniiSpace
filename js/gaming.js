document.addEventListener('DOMContentLoaded', function () {
  ...
  form.addEventListener('submit', function (event) {
    ...
    var whatsappLink = document.getElementById('gamingWhatsappLink');
    whatsappLink.href = 'https://wa.me/27697304534?text=' + encodeURIComponent(message);

    var emailLink = document.getElementById('gamingEmailLink');
    emailLink.href = 'mailto:internetsmarthub@gmail.com?subject=' +
      encodeURIComponent('Gaming PC Ticket ' + ticketId) +
